 ...
 *
 * (default: 0.6 msec * (1 + ilog(ncpus)), units: nanoseconds)
 */
unsigned int sysctl_sched_min_granularity		= 600000UL;
unsigned int normalized_sysctl_sched_min_granularity	= 600000UL;
